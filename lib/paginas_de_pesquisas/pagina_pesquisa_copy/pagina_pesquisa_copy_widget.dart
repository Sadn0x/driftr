...
import 'pagina_pesquisa_copy_model.dart';
export 'pagina_pesquisa_copy_model.dart';

class PaginaPesquisaCopyWidget extends StatefulWidget {
  const PaginaPesquisaCopyWidget({Key? key}) : super(key: key);

  @override
  _PaginaPesquisaCopyWidgetState createState() =>
      _PaginaPesquisaCopyWidgetState();
}

class _PaginaPesquisaCopyWidgetState extends State<PaginaPesquisaCopyWidget> {
  late PaginaPesquisaCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PaginaPesquisaCopyModel());
                                              ...
                                              Padding(
                                                ...
                                                child: InkWell(
                                                  ...
                                                  child:
                                                    ...
                                                    key: Key(
                                                        'Keyry8_${listViewIndex}_of_${listViewVooRecordList.length}'),
